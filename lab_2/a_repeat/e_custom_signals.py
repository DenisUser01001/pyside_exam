...
class Window(QtWidgets.QWidget):
    ...
    def __initSignals(self):
        self.__pushButton.clicked.connect(self.showRegWindow)

    def showRegWindow(self):
        self.rw = RegistrationWindow()
        self.rw.registered.connect(self.userDataRecieved)
        self.rw.show()
...
class RegistrationWindow(QtWidgets.QWidget):
    ...
    def __initUi(self):
        ...
        self.pushButtonRegistration.clicked.connect(self.onPushButtonRegistrationClicled)
    ...
    def onPushButtonRegistrationClicled(self):
